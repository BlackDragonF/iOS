...
- (UIButton *)finishButton {
    if (!_finishButton) {
        ...
        [_finishButton setBackgroundColor:[UIColor blackColor]];
...
- (void)scrollViewDidZoom:(UIScrollView *)scrollView {
    self.scrollView.contentSize = CGSizeMake(_imageSize.width*self.scrollView.zoomScale+WIDTH-LENGTH, _imageSize.height*self.scrollView.zoomScale+HEIGHT-LENGTH-84);
}
...
- (void)imageConfiguration {
    ...
    self.scrollView.contentSize = CGSizeMake(_imageSize.width*zoomScale+WIDTH-LENGTH, _imageSize.height*zoomScale+HEIGHT-LENGTH-84);
